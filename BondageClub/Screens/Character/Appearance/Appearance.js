...
function CharacterAppearanceVisible(C, AssetName, GroupName, Recursive = true) {
	...
	for (let A = 0; A < C.Appearance.length; A++) {
		...
		if ((C.Appearance[A].Asset.Hide != null) && (C.Appearance[A].Asset.Hide.includes(GroupName)) && !C.Appearance[A].Asset.HideItemExclude.includes(GroupName + AssetName)) HidingItem = true;
		else if ((C.Appearance[A].Property != null) && (C.Appearance[A].Property.Hide != null) && (C.Appearance[A].Property.Hide.includes(GroupName)) && (!C.Appearance[A].Property.HideItemExclude || !C.Appearance[A].Property.HideItemExclude.includes(GroupName + AssetName))) HidingItem = true;
