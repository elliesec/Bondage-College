...
function PreferenceInit(C) {
	...
	if (!C.ChatSettings) C.ChatSettings = { DisplayTimestamps: true, ColorNames: true, ColorActions: true, ColorEmotes: true, ShowActivities: true, AutoBanGhostList: true, AutoBanBlackList: false, DisableAnimations: false };
...
function PreferenceSubscreenChatClick() {
	...
	if ((MouseX >= 1200) && (MouseX <= 1264)) {
		...
		if ((MouseY >= 652) && (MouseY <= 726)) Player.ChatSettings.DisableAnimations = !Player.ChatSettings.DisableAnimations;
	}
