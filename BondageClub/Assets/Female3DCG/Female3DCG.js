...
var AssetFemale3DCG = [
...

	{
		...
		Asset: [
			...
			{ Name: "HempRopeHarness", Fetish: ["Rope"], Value: 60, Difficulty: 3, Time: 20, RemoveTime: 25, DefaultColor: "#956B1C", BuyGroup: "HempRope", Audio: "RopeShort", Prerequisite: "AccessTorso", AllowType: ["Harness", "Diamond", "Star", "Waist"], AllowPose: ["OverTheHead"], OverrideAllowPose: ["AllFours", "Hogtied"], Extended: true },
