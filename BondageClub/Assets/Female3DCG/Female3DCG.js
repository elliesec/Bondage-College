...
var AssetFemale3DCG = [
...

	{
		...
		Asset: [
			...
			{ Name: "LoversVibrator", Value: 75, Time: 5, Visible: false, LoverOnly: true, Prerequisite: ["AccessVulva", "AccessVulvaSuitZip"], Effect: ["Egged"], AllowEffect: ["Egged", "Vibrating", "Edged"], ExpressionTrigger: [{ Name: "Low", Group: "Blush", Timer: 10 }], AllowRemoveExclusive: true, CharacterRestricted: true},
