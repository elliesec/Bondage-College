...
var AssetFemale3DCG = [
...

	{
		...
		Asset: [
			...
			{ Name: 'WebBlindfold', Value: 10, Difficulty: 5, Time: 10, RemoveTime: 5, Hide: ['Glasses'], Effect: ['BlindLight', 'Prone'], AllowEffect: ['BlindHeavy'], AllowType: ['Cocoon'], Extended: true },
			AssetSpankingToys
		],
		Color: ["Default"]
	},
