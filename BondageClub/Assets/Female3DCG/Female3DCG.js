...
var AssetFemale3DCG = [
...

	{
		...
		Asset: [
			...
			{
				Name: "HempRopeBelt", Fetish: ["Rope"], Value: 60, Time: 24, DefaultColor: ["#956B1C", "Default"], BuyGroup: "HempRope", Prerequisite: ["CannotHaveWand"], HideItem: ["ClothLowerPajama1", "ClothLowerMistressBottom"], Effect: ["Egged"], AllowEffect: ["Egged", "Vibrating"], Block: ["ItemPelvis"], ExpressionTrigger: [{ Name: "Medium", Group: "Blush", Timer: 10 }],
				Layer: [
					{ Name: "Rope" },
					{ Name: "Wand" }
				]
...

	{
		...
		Asset: [
			...
			{
				Name: "WristShackles", Fetish: ["Metal"], Value: 80, Difficulty: 6, Time: 20, Random: false, AllowLock: true, Extended: true, ParentGroup: null,
				AllowPose: ["BackCuffs"],
				Effect: ["Prone"],
...

	{
		...
		Asset: [
			...
			{
				Name: "Cage", Fetish: ["Metal"], Value: 120, Difficulty: 4, Time: 15, RemoveTime: 10, AllowLock: true, RemoveAtLogin: true,
