...
var AssetFemale3DCG = [
...

	{
		...
		Asset: [
			...
			{ Name: "WebBlindfold", Value: 50, Difficulty: 5, Time: 10, RemoveTime: 20, Hide: ["Glasses"], Effect: ["BlindLight", "Prone"], AllowEffect: ["BlindHeavy", "GagNormal"], AllowType: ["Cocoon"], Extended: true },
			AssetSpankingToys
		],
		Color: ["Default"]
	},
