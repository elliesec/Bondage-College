...

	{
		...
		Asset: [
			...
			{ Name: "HighSecurityStraitJacket", Value: 220, Priority: 25, Difficulty: 4, SelfBondage: 2, Time: 45, RemoveTime: 30, Random: false, AllowLock: true, DefaultColor: ["#333", "#333", "#3e3e3e", "#3e3e3e"], Hide: ["Cloth", "ItemNipplesPiercings"], SetPose: ["BackElbowTouch"], Effect: ["Block", "Prone"],
				...
				AllowType: [/^c[01]a[012]s[0123]$/],
				Block: ["ItemNipples", "ItemNipplesPiercings", "ItemTorso", "ItemBreast", "ItemHands"],
				DefaultType: "c0a0s0",
				Extended: true,
				Layer: [
					{ Name: "Crotch", ColorGroup: "Canvas", ParentGroup: null, AllowTypes: [/^c1a[012]s[0123]$/], HasType: false },
					{ Name: "JacketLoose", ColorGroup: "Canvas", ParentGroup: null, AllowTypes: [/^c[01]a0s[0123]$/], HasType: false},
					{ Name: "JacketFront", CopyLayerColor: "JacketLoose", AllowTypes: [/^c[01]a1s[0123]$/], HasType: false },
					{ Name: "JacketBack", CopyLayerColor: "JacketLoose", AllowTypes: [/^c[01]a2s[0123]$/], HasType: false },
					{ Name: "StrapsLoose", ColorGroup: "Straps", AllowTypes: [/^c[01]a0s[0123]$/], HasType: false},
					{ Name: "StrapsFront", CopyLayerColor: "StrapsLoose", AllowTypes: [/^c[01]a1s[0123]$/], HasType: false },
					{ Name: "StrapsBack", CopyLayerColor: "StrapsLoose", AllowTypes: [/^c[01]a2s[0123]$/], HasType: false },
					{ Name: "CrotchStrapsSingle", ColorGroup: "Straps", ParentGroup: null, AllowTypes: [/^c[01]a[012]s1$/], HasType: false },
					{ Name: "CrotchStrapsDouble", CopyLayerColor: "CrotchStrapsSingle", ParentGroup: null, AllowTypes: [/^c[01]a[012]s2$/], HasType: false },
					{ Name: "CrotchStrapsTriple", CopyLayerColor: "CrotchStrapsSingle", ParentGroup: null, AllowTypes: [/^c[01]a[012]s3$/], HasType: false },
				],
				SelfUnlock: false
			},
